 ...
 */
abstract class Feast_Autohooker {
	 ...
	 */
	protected static function check_eaccelerator_saneness() {
		if (!extension_loaded('eaccelerator') && !extension_loaded('eAccelerator')) {
			return true;
		}

		$method = new ReflectionMethod('Feast_Autohooker', 'check_eaccelerator_saneness');
